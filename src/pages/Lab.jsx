...
`);
    ...
    // Remove handleLoadTree entirely if unused, or just ignore it.
    // Removing the button below as requested.
    ...
    return (
        <div className="h-full p-6 gap-6 flex flex-col md:flex-row bg-slate-50/0">
            ...
            <div className="flex-1 flex flex-col bg-[#1e1e1e] rounded-lg overflow-hidden shadow-xl border border-gray-800">
                ...
                {/* Toolbar (Overlay or Separate) - Keeping underneath for functionality, but stylized dark */}
